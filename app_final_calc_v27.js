// ====================================================================
//  app_final_calc_v27.js
//  - modály (obrázek, vzorec, nápověda, kalkulačka)
//  - reset při novém příkladu (klik + změna zadání)
//  - „+ Přidat veličinu“, kontrola zápisu, nový výpočetní box (3 řádky)
//  - žádné staré single-inputy v HTML
//  - logy ponechány
// ====================================================================

console.log("🧩 Načítání app_final_calc_v27.js ...");
...
(function () {
  ...
  function renderCalcBox() {
    ...
    log("✅ výpočetní box v27 vykreslen");
  }
  ...
  function resetForNewProblem() {
    ...
    addZapisRow(); // jedna prázdná řádka
