...
// ====================================================================
//  🧮 ROZŠÍŘENÍ: DVOUPÓLOVÁ POLE PRO VÝPOČET (LHS = RHS)
// ====================================================================
...
(function () {
  ...
  function attachTwoFieldCalc() {
    ...
    buildTwoFieldRow(formulaInput, { key: "formula", placeholderLHS: "např. W", placeholderRHS: "F * s" });
    buildTwoFieldRow(substitutionInput, { key: "subs", placeholderLHS: "např. W", placeholderRHS: "např. 1000 * 2" });
    buildTwoFieldRow(userAnswerInput, { key: "result", placeholderLHS: "např. W", placeholderRHS: "např. 2000" });
  }
  ...
  function initWhenReady() {
    ...
    try {
      attachTwoFieldCalc();
      wireResets();
      console.log("🧮 Dvoupólová pole výpočtu aktivována.");
    } catch (e) {
      console.warn("[two-field-calc] init error:", e);
    }
  }
